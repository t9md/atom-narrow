...
module.exports = {
  ...
  registerCommands () {
    ...
    return atom.commands.add('atom-text-editor', {
      ...
      // ==== composition based
      'narrow:x-symbols': () => this.startNarrow('symbols'),
      'narrow:x-symbols-by-current-word': () => this.startNarrow('symbols', {queryCurrentWord: true}),

      'narrow:x-project-symbols': () => this.startNarrow('project-symbols'),
      'narrow:x-project-symbols-by-current-word': () => this.startNarrow('project-symbols', {queryCurrentWord: true}),

      'narrow:x-git-diff-all': () => this.startNarrow('git-diff-all'),
      ...
      'narrow:x-search': () => this.startNarrow('search'),
      'narrow:x-search-by-current-word': () => this.startNarrow('search', {queryCurrentWord: true}),
      'narrow:x-search-by-current-word-without-focus': () => this.startNarrow('search', {queryCurrentWord: true, focus: false}),
      'narrow:x-search-current-project': () => this.startNarrow('search', {currentProject: true}),
      'narrow:x-search-current-project-by-current-word': () => this.startNarrow('search', {currentProject: true, queryCurrentWord: true}),

      'narrow:x-atom-scan': () => this.startNarrow('atom-scan'),
      'narrow:x-atom-scan-by-current-word': () => this.startNarrow('atom-scan', {queryCurrentWord: true})
      // ==== composition based
    })
  },
