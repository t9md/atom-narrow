...
module.exports = {
  ...
  activate (state) {
    ...
    settings.forceMigrationOldConfiguration()
  },
  ...
  registerCommands () {
    ...
    return atom.commands.add('atom-text-editor', {
      ...
      'narrow:toggle': () => getUi(ui => ui.toggle()),
  ...
  consumeVim ({getEditorState, observeVimStates}) {
    this.subscriptions.add(
      observeVimStates(vimState => {
        ...
        // Ui.register(ui) is always called before creating vimState from ui.outlet.
    ...
    function confirmSearch () {
      ...
      atom.commands.dispatch(vimState.editor.element, 'vim-mode-plus:clear-highlight-search')
      return text
    }
