...
class Ui {
  ...
  constructor (provider, {query = ''} = {}, restoredState) {
    ...
    this.directionOpen = this.provider.getConfig('directionToOpen')
    ...
    this.editor.link(this.provider.editor)
  ...
  toggle () {
    if (getLocationForItem(this.editor) === 'center' && this.protected) {
      return
    }
    this.editor.toggle()
  }
