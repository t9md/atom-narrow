...
class Ui {
  ...
  updateLastLocation () {
    this.constructor.lastLocationByProviderName[this.provider.name] = this.narrowEditor.getLocation()
  }

  getLocationToOpen () {
    return this.constructor.lastLocationByProviderName[this.provider.name] || this.locationToOpen
  }
