...
class Ui {
  ...
  setReadOnly (readOnly) {
    this.itemEditor.setReadOnly(readOnly)
  }
  ...
  observeItemEditor () {
    ...
    disposables.add(
      ...
      this.itemEditor.onDidQueryChange(() => {
  ...
  moveToDifferentFileItem (direction) {
    if (!this.itemEditor.isAtSelectedItem()) {
      this.itemEditor.moveToSelectedItem({ignoreCursorMove: false})
      return
    }
