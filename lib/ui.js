  ...
  getFilterSpec (providerName, filterQuery) {
    if (filterQuery) {
      return new FilterSpec(filterQuery, {
        negateByEndingExclamation: this.provider.getConfig('negateNarrowQueryByEndingExclamation'),
        sensitivity: this.provider.getConfig('caseSensitivityForNarrowQuery')
      })
    }
  }
